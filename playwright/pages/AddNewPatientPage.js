...
class AddNewPatientPage extends UtilityMethods {
    ...
    async AddPatient() {
        ...
        await this.locateFill('#UnMaskedValue_SearchDetailsModel_ClinicomNumber', process.env.PLAYWRIGHT_ADDPATIENTFOLDERNO);
        ...
        await this.locateFill('#FirstName', process.env.PLAYWRIGHT_ADDPATIENTFIRSTNAME);
        await this.click('#Surname');
        await this.locateFill('#Surname', process.env.PLAYWRIGHT_ADDPATIENTLASTNAME);
        
        await this.click('#IdNumber');
        await this.locateFill('#IdNumber',process.env.PLAYWRIGHT_ADDPATIENTIDNO);
        await this.page.locator('#Sex').selectOption(process.env.PLAYWRIGHT_ADDPATIENTSEX);
...
module.exports = AddNewPatientPage;