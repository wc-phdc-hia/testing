...
class ChangePwdPage extends UtilityMethods {
    constructor(page) {
        super(page);
    ...
    async ChangePwd() {
        ...
        await this.type('//*[@id="row00jqxgrid"]/div[2]', process.env.PLAYWRIGHT_CHANGEUSERUSERNAME);
        ...
        await this.locateFill('#NewPassword', process.env.PLAYWRIGHT_CHANGEUSERNEWPWD);
        await this.click('#ConfirmPassword')
        await this.locateFill('#ConfirmPassword', process.env.PLAYWRIGHT_CHANGEUSERNEWPWD);
        await this.clickButtonByRoleAndName('button', 'Change Password');

    }
}
module.exports = ChangePwdPage;