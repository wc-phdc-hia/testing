...
class EditUserPage extends UtilityMethods {
    ...
    async Edituser() {
        ...
        await this.type('//*[@id="row00jqxgrid"]/div[2]', process.env.PLAYWRIGHT_EDITUSERUSERNAME);
        await this.page.locator('//*[@id="row00jqxgrid"]/div[2]').press('Enter');
        await this.page.waitForTimeout(5000);
        await this.click('//*[@id="row0jqxgrid"]/div[9]/div/a[1]');
        await this.locateFill('#FirstName', process.env.PLAYWRIGHT_EDITUSERFIRSTNAME);
        ...
        await this.locateFill('#PrimaryPlaceOfWork', process.env.PLAYWRIGHT_EDITUSERPLACEOFWORK);
        await this.page.waitForTimeout(5000);
