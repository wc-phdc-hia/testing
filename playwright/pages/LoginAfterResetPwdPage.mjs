...
class LoginAfterResetPwdPage extends UtilityMethods {
  ...
  async LoginAfterResetPwd() {
    ...
    await this.page
      ...
      .fill(process.env.PLAYWRIGHT_LOGINAFTERRESETPWDUSERNAME);
    await this.page.getByPlaceholder("Enter your password").click();
    await this.page
      .getByPlaceholder("Enter your password")
      .fill(process.env.PLAYWRIGHT_LOGINAFTERRESETPWDPWD);
    ...
    await this.page
      ...
      .fill(process.env.PLAYWRIGHT_LOGINAFTERRESETPWDNEWPWD);
